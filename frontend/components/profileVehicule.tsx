      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="md:w-1/2 space-y-4">
          ...
          <div>
            ...
            <p className="text-indigo-300 text-lg italic">{type} - Année {year}</p>
          </div>

          {/* Tarif */}
          <div className="bg-indigo-600 px-6 py-4 rounded-xl shadow-md inline-block">
            <p className="text-2xl font-semibold">
              Tarif: {price.toFixed(2)} €<span className="text-base font-normal">/jour</span>
            </p>
          </div>
      ...
      <div className="mt-6 text-center">
        <button
          ...
          onClick={() => {
            ...
            console.log(`Reserving vehicle with license plate: ${licensePlate}`);
          }}
        >
