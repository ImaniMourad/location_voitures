...
export default function Card({imageSrc, marque, modele, annee, tarifLocation, type, to, key}: CardProps) {
    return (
        <a
        ...
        >
            <div
                ...
                {/* Image */}
                <Image
                    className="inline-flex w-full h-48 object-cover"
                    src={imageSrc}
                    width={350}
                    height={288}
                    alt={`${marque} ${modele}`}
                ...
                {/* Content */}
                <div className="p-6">
                    <h3 className="text-xl font-semibold text-white mb-2">{marque} {modele}</h3>
                    <div className="mb-3">
            <span
